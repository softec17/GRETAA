function xdot = SixDOFEntryVinhEOMMSL(t,x,inputs)
...
statedot = SixDOFEntryEOMVinhEOMMSL(t,x(1:n_states),inputs);
covdot = SixDOFEntryCOVVinhEOMMSL(t,x(1+n_states:end),x(1:n_states),inputs);
