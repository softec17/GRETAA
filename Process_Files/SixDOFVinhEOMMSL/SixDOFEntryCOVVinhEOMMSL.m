function covdot = SixDOFEntryCOVVinhEOMMSL(t,xcov,xstates,inputs)
...
F = SixDOFEntryEOMVinhEOMjacMSL(t,xstates,inputs);

% Process noise vector associated with the equations of motion
Q = SixDOFEntryEOMQMatVinhEOMMSL(t,xstates,inputs);
