function xdot = SixDOFEntryVinhEOMMSLEOMAccel(t,x,inputs)
...
statedot = SixDOFEntryEOMVinhEOMMSLEOMAccel(t,x(1:n_states),inputs);
covdot = SixDOFEntryCOVVinhEOMMSLEOMAccel(t,x(1+n_states:end),x(1:n_states),inputs);
