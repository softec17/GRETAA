function [CA,CN] = aero_interpMSL2_CACN(AOA_grid,Mach_grid,data_grid,alpha,beta,Mach)
...
CA = interp2(AOA_grid_local,Mach_grid_local,data_grid_local(:,:,1),total_alpha,Mach);
CN = interp2(AOA_grid_local,Mach_grid_local,data_grid_local(:,:,2),total_alpha,Mach);
